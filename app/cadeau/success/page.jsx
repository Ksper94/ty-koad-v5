  ...
  if (state.error) {
    return (
      <div className="rounded-2xl border p-6 bg-white">
        ...
        <Link
          href="/cadeau"
          className="inline-block mt-4 px-4 py-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white shadow-sm"
        >
          Revenir
        </Link>
      </div>
    ...
    <div className="rounded-2xl border p-6 bg-white">
      ...
      {state.downloadUrl && (
        <a
          ...
          className="inline-flex mt-6 px-4 py-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white shadow-sm"
        >
          Télécharger le PDF
        </a>
      )}
      <div className="mt-6">
        <Link href="/" className="text-emerald-900 underline">
          Retour à l’accueil
        </Link>
      </div>
    </div>
